export default {
	...
	"font": {
		"headline1": "normal 500 80px/1.1 --fontFamily-sans",
		"headline2": "normal 400 52px/1.2 --fontFamily-googleInter",
		"headline3": "normal 400 36px/1.5 --fontFamily-googleInter",
		"base": "normal 300 16px/1.5 --fontFamily-sans",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"subheader": "normal 400 20px/1.5 --fontFamily-googleInter",
		"title": "normal 500 20px/1.5 --fontFamily-sans",
		"subtitle": "500 16px/1.5 --fontFamily-googleInter",
		"paragraph": "400 16px/1.5 --fontFamily-googleInter",
		"link": "500 16px/1.5 --fontFamily-googleInter",
		"button": "500 17px/1.5 --fontFamily-googleInter",
		"menu": "400 30px/1.5 --fontFamily-googleInter"
	},
	"boxShadow": {
		...
		"shadow": "0 4px 31px rgba(0, 0, 0, 0.15)"
	},
	"background": {
	...
	"transition": {
		...
		"all": "all --transitionDuration-normal ease 0s",
		"width": "width --transitionDuration-normal ease 0s",
		"color": "color --transitionDuration-normal ease 0s",
